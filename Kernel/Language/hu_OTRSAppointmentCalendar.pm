...
sub Data {
    ...
    $Self->{Translation}->{'Appointment reminder notification'} = 'Időpont emlékeztető értesítés';
    ...
    $Self->{Translation}->{'Appointment Notification Management'} = 'Időpont-értesítés kezelés';
    ...
    $Self->{Translation}->{'Appointment Filter'} = 'Időpont szűrő';
    ...
    $Self->{Translation}->{'To get the first 20 character of the appointment title.'} = 'Az időpontcím első 20 karakterének lekéréséhez.';
    $Self->{Translation}->{'To get the appointment attribute'} = 'Az időpont jellemzőjének lekéréséhez';
    ...
    $Self->{Translation}->{'Add Appointment'} = 'Időpont hozzáadása';
    ...
    $Self->{Translation}->{'Appointment'} = 'Időpont';
    $Self->{Translation}->{'This is a repeating appointment'} = 'Ez egy ismétlődő időpont';
    ...
    $Self->{Translation}->{'Import Appointments'} = 'Időpontok importálása';
    ...
    $Self->{Translation}->{'Ticket Appointments'} = 'Jegyidőpontok';
    ...
    $Self->{Translation}->{'Add new Appointment'} = 'Új időpont hozzáadása';
    ...
    $Self->{Translation}->{'This an occurrence of a repeating appointment.'} = 'Ez egy ismétlődő időpont előfordulása.';
    $Self->{Translation}->{'Click here to see the parent appointment.'} = 'Kattintson ide a szülőidőpont megtekintéséhez.';
    $Self->{Translation}->{'Click here to edit the parent appointment.'} = 'Kattintson ide a szülőidőpont szerkesztéséhez.';
    ...
    $Self->{Translation}->{'Appointment Import'} = 'Időpont importálása';
    ...
    $Self->{Translation}->{'Update existing appointments?'} = 'Frissíti a meglévő időpontokat?';
    ...
    $Self->{Translation}->{'New Appointment'} = 'Új időpont';
    ...
    $Self->{Translation}->{'Agent (resources), who are selected within the appointment'} = 'Ügyintéző (erőforrások), aki az időponton belül ki lett jelölve';
    ...
    $Self->{Translation}->{'Successfully imported %s appointment(s) to calendar %s.'} = '%s időpont sikeresen importálva a(z) %s naptárba.';
    ...
    $Self->{Translation}->{'All appointments'} = 'Minden időpont';
    $Self->{Translation}->{'Appointments assigned to me'} = 'Hozzám rendelt időpontok';
    $Self->{Translation}->{'Showing only appointments assigned to you! Change settings'} = 'Csak az önhöz rendelt időpontok vannak megjelenítve! Beállítások megváltoztatása';

    # Perl Module: Kernel/Modules/AgentAppointmentEdit.pm
    $Self->{Translation}->{'Appointment not found!'} = 'Az időpont nem található!';
    ...
    $Self->{Translation}->{'before the appointment starts'} = 'az időpont kezdete előtt';
    $Self->{Translation}->{'after the appointment has been started'} = 'miután az időpont elkezdődött';
    $Self->{Translation}->{'before the appointment ends'} = 'az időpont vége előtt';
    $Self->{Translation}->{'after the appointment has been ended'} = 'miután az időpont véget ért';
    $Self->{Translation}->{'No permission!'} = 'Nincs jogosultság!';
    $Self->{Translation}->{'Cannot delete ticket appointment!'} = 'Nem lehet törölni a jegyidőpontot!';
    ...
    $Self->{Translation}->{'Please check the log for more information.'} = 'További információkért nézze meg a naplót.';
    ...
    # SysConfig
    $Self->{Translation}->{'Appointment Calendar overview page.'} = 'Időpontnaptár áttekintő oldal.';
    $Self->{Translation}->{'Appointment Notifications'} = 'Időpont-értesítések';
    ...
    $Self->{Translation}->{'Appointment edit screen.'} = 'Időpontszerkesztés képernyő.';
    $Self->{Translation}->{'Appointment list'} = 'Időpontlista';
    $Self->{Translation}->{'Appointment list.'} = 'Időpontlista.';
    $Self->{Translation}->{'Appointment notifications'} = 'Időpont-értesítések';
    $Self->{Translation}->{'Appointments'} = 'Időpontok';
    ...
    $Self->{Translation}->{'Create a new calendar appointment linked to this ticket'} = 'Ezzel a jeggyel összekapcsolt új naptáridőpont létrehozása';
    $Self->{Translation}->{'Create and manage appointment notifications.'} = 'Időpont-értesítések létrehozása és kezelése.';
    $Self->{Translation}->{'Create new appointment.'} = 'Új időpont létrehozása.';
    ...
    $Self->{Translation}->{'Defines the ticket plugin for calendar appointments.'} = 'Meghatározza a jegybővítményt a naptáridőpontokhoz.';
    $Self->{Translation}->{'DynamicField_%s'} = 'DynamicField_%s';
    $Self->{Translation}->{'Edit appointment'} = 'Időpont szerkesztése';
    $Self->{Translation}->{'First response time'} = 'Első válaszidő';
    $Self->{Translation}->{'Import appointments screen.'} = 'Időpontok importálása képernyő.';
    $Self->{Translation}->{'Links appointments and tickets with a "Normal" type link.'} = 'Összekapcsolja az időpontokat és jegyeket egy „Normál” típusú hivatkozással.';
    $Self->{Translation}->{'List of all appointment events to be displayed in the GUI.'} = 'Az összes időpontesemény listája, amelyek megjelennek a grafikus felületen.';
    ...
    $Self->{Translation}->{'Overview of all appointments.'} = 'Az összes időpont áttekintője.';
    ...
    $Self->{Translation}->{'Transport selection for appointment notifications.'} = 'Átvitelkiválasztás az időpont-értesítésekhez.';
