...
sub Data {
    ...
    $Self->{Translation}->{'Appointment reminder notification'} = 'Obaveštenje podsetnika o terminu';
    ...
    $Self->{Translation}->{'Please check the log for more information.'} = 'Molimo proverite log za više informacija.';
