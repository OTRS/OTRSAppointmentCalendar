...
# --
# $origin: https://github.com/OTRS/otrs/blob/adeed4e09cfe05e7b12786d72b5408b7ec0b2bfc/Kernel/Modules/AdminNotificationEvent.pm
# --
...
#    );
    ...
    # get the registered event object types out of the sysconfig
    my $EventObjectTypes = $ConfigObject->Get("Frontend::Admin::$Self->{Action}")->{EventObjectTypes};

    my %RegisteredEvents = $Kernel::OM->Get('Kernel::System::Event')->EventList(
        ObjectTypes => $EventObjectTypes,
    );
